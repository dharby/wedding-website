...
{/* Skip button */}
        <motion.button
          initial={{ opacity: 0 }}
          animate={{ opacity: phase === "ready" ? 0.7 : 0 }}
          transition={{ duration: 0.6, delay: 1.2 }}
          whileHover={{ opacity: 1 }}
          onClick={handleSkip}
          className="mt-3 text-[0.6rem] sm:text-[0.65rem] uppercase tracking-[0.25em] text-emerald/95 dark:text-gold/90 font-sans font-medium hover:text-emerald/100 dark:hover:text-gold/100 transition-colors select-none"
        >
          Skip Intro
        </motion.button>
        ...
        <motion.p
          ...
          className="mt-4 max-w-xs text-center text-[0.6rem] sm:text-[0.65rem] uppercase tracking-[0.2em] font-sans font-medium"
          style={{ color: isDark ? "rgba(197,160,89,0.9)" : "rgba(14,40,30,0.8)", textShadow: "0 1px 2px rgba(0,0,0,0.05)" } as React.CSSProperties}
        >
        ...
        <motion.div
          ...
          className="mt-5 flex items-center justify-center gap-2 text-[0.6rem] sm:text-[0.65rem] uppercase tracking-[0.15em] font-sans font-medium"
          style={{ color: isDark ? "rgba(197,160,89,0.8)" : "rgba(14,40,30,0.65)" }}
        >
          <span>Website & Photography by</span>
          <a
            href="https://www.instagram.com/cleekrightstudios?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw=="
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1 hover:text-gold/100 transition-colors"
            style={{ color: isDark ? "rgba(251,249,244,0.95)" : "rgba(14,40,30,0.9)" }}
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-3.583-.07-4.849-.149-3.227-1.664-4.771-4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
            </svg>
            <span className="font-sans font-medium tracking-wide">@cleekrightstudios</span>
          </a>
        </motion.div>
      </div>
    </div>
