    ...
    >
      ...
      <div className="relative flex flex-col items-center px-6">
        ...
        <motion.div
          ...
          className="mt-5 flex items-center justify-center gap-2 text-[0.5rem] sm:text-[0.55rem] uppercase tracking-[0.15em] font-sans"
          style={{ color: isDark ? "rgba(197,160,89,0.5)" : "rgba(14,40,30,0.4)" }}
        >
          ...
          <a
            ...
            style={{ color: isDark ? "rgba(251,249,244,0.8)" : "rgba(14,40,30,0.7)" }}
          >
<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <span className="font-sans tracking-wide">@cleekrightstudios</span>
          </a>
        </motion.div>
      </div>
    </div>
